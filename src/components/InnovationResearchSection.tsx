...
const InnovationResearchSection = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-background relative overflow-hidden">
      {/* Background illustration for mobile */}
      <div className="lg:hidden absolute inset-0 opacity-5">
        <img 
          src="/cartoons/undraw_connected-world_anke.svg"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                {ideathonResults.map((result, index) => (
                  ...
                  >
                    <Card className="hover:shadow-lg transition-all duration-300 bg-card/80 backdrop-blur-sm border-border/50 hover:bg-card/95">
            ...
            <div>
              ...
              <motion.div 
                className="mt-6 bg-gradient-to-br from-primary/5 to-accent/5 rounded-xl p-6 backdrop-blur-sm"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
