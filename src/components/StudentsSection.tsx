...
const StudentsSection = () => {
  ...
  const testimonials = [
    {
      ...
      quote: "The CSE-AIML program at AMC gave me hands-on experience with cutting-edge AI technologies. The research opportunities and industry mentorship were invaluable in shaping my career.",
      rating: 5,
    },
    {
      name: 'Priya Sharma',
      ...
      quote: "The faculty's expertise and the state-of-the-art labs provided the perfect environment for innovation. I published 3 papers during my time here and landed my dream job.",
      rating: 5,
    },
    {
      name: 'Rahul Patel',
      ...
      quote: "The industry partnerships and real-world projects helped me understand how AI is applied in practice. The career support team was exceptional in helping me secure placement.",
      rating: 5,
    },
    {
      name: 'Sneha Reddy',
      ...
      quote: "Working on computer vision projects with GPU clusters gave me practical experience that directly translated to my role at NVIDIA. The program exceeded my expectations.",
      rating: 5,
    },
  ];
  ...
  const placementStats = [
    {
      ...
      description: 'Students placed within 6 months of graduation',
    },
    {
      icon: Award,
      metric: '₹18.5L',
      label: 'Average Package',
      description: 'Highest domestic package offered',
    },
    {
      icon: Briefcase,
      metric: '150+',
      label: 'Companies',
      description: 'Global tech companies recruiting our students',
    },
    {
      icon: Users,
      metric: '500+',
  ...
  const topRecruiters = [
    { name: 'Google', package: '₹45L' },
    { name: 'Microsoft', package: '₹42L' },
    { name: 'Amazon', package: '₹38L' },
    { name: 'NVIDIA', package: '₹40L' },
    { name: 'Intel', package: '₹35L' },
    { name: 'Adobe', package: '₹32L' },
    { name: 'Salesforce', package: '₹36L' },
    { name: 'Meta', package: '₹48L' },
  ];
